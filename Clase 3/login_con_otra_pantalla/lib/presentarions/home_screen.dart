...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List artists = [
      ...
      'Taylor Swift','One Direction','Coldplay','Árbol','Tan Bionica','Sam Smith','Queen','Airbag',
      'Julieta Venegas','Koino Yokan','Koino Yokan','Taylor Swift','Florence + The Machine','Koino Yokan',
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Card(
            color: Color.fromARGB(255, 148, 198, 207),
            child: ListTile(
